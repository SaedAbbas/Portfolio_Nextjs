...
class App {
  ...
  createMedias(
    ...
    const defaultItems = [
      ...
      { image: "/tailwind.png", text: "Tailwind CSS" },
      { image: "/framermotion.png", text: "Framer Motion" },
      { image: "/redux.png", text: "Redux Toolkit" },
      { image: "/reactquery.png", text: "Tanstack Query" },
